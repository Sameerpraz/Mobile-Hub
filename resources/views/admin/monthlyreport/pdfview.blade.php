    ...
    <div class="table-responsive">
        <table class=" table table-hover" style="width: 100%;">
            ...
            <tr>
                ...
                <td class="text-bold" style="font-weight: bolder">Rs. {{$total_revenue_count}}</td>
...
<br>
<br>
<p style="float:right;"><b>Total Revenue from order expected:</b>Rs. {{$total_revenue_count}}</p>
